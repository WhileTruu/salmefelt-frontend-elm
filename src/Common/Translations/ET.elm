module Common.Translations.ET exposing (translations)
...
translations =
    ...
    , body_text =
        ...
        OÜ Salmefelt toodanguks on eridisainiga viltimistehnikas mütsid, sallid,
        vaipkatted ja suveniirnukud.<br>
